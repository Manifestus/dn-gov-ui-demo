...
const sortOptions: SortOption[] = [
  {
    label: t(tokens.fileManager.latest).toString(),
    value: 'desc'
  },
  {
    label: t(tokens.fileManager.oldest).toString(),
    value: 'asc'
  }
];
      ...
      >
        ...
        >
          <OutlinedInput
            ...
            name="itemName"
            placeholder={t(tokens.fileManager.search).toString()}
            startAdornment={(
        ...
        <TextField
          label={t(tokens.fileManager.order)}
          name="sort"

          ...
          >
            ...
            >
              <Typography
                ...
                variant="caption"
              >
                {t(tokens.fileManager.createdBy)}
              </Typography>
            </Grid>
            <Grid
              xs={12}
            ...
            >
              <Typography
                ...
                variant="caption"
              >
                {t(tokens.fileManager.createdAt)}
              </Typography>
            </Grid>
            <Grid
              xs={12}
            ...
            >
              <Typography
                ...
                variant="caption"
              >
                {t(tokens.fileManager.modifiedAt)}
              </Typography>
            </Grid>
            <Grid
              xs={12}

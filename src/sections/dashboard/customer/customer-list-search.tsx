...
const sortOptions: SortOption[] = [
  {
    label: t(tokens.taxpayers.lastUpdateNewest),
    value: 'updatedAt|desc'
  },
  {
    label: t(tokens.taxpayers.lastUpdateOldest),
    value: 'updatedAt|asc'
  },
  {
    label: t(tokens.taxpayers.totalOrdersHighest),
    value: 'totalOrders|desc'
  },
  {
    label: t(tokens.taxpayers.totalOrdersLowest),
      ...
      >
        ...
        >
          <OutlinedInput
            ...
            placeholder={t(tokens.taxpayers.searchTaxpayer) || undefined}
            startAdornment={(
        ...
        <TextField
          label={t(tokens.taxpayers.sortBy)}
          name="sort"
